        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
            <div className="inline-block bg-blue-50 px-4 py-1.5 rounded-full text-primary text-sm font-medium mb-5 animate-fade-in">
              Introducing EduWallet
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-in">
              Simplifying School Fee Payments & Financial Management
            </h1>
            
            <p className="text-lg text-muted-foreground mb-8 animate-fade-in stagger-1">
              Effortlessly manage school fees, save for education, and get financial tips, all in one app.
            </p>
            
            <p className="text-sm text-muted-foreground mb-10 animate-fade-in stagger-2">
              Secure, easy-to-use, and integrated with MightyFin's trusted digital wallet.
            </p>
          ...
          <div className="hidden lg:block relative">
            ...
            <div className="relative animate-float">
              <div className="relative p-6 bg-white rounded-[32px] shadow-xl border border-gray-100">
                <div className="w-full h-[500px] rounded-2xl bg-gradient-to-br from-blue-500 to-blue-400 shadow-sm overflow-hidden relative">
                  <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80')] bg-cover bg-center opacity-20" />
